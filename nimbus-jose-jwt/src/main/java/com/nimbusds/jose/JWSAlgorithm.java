...
public final class JWSAlgorithm extends Algorithm {
	...
	/**
	 * Post-Quantum ML-DSA using 44 parameters (optional).
	 */
	public static final JWSAlgorithm ML_DSA_44 = new JWSAlgorithm("ML-DSA-44", Requirement.OPTIONAL);

	/**
	 * Post-Quantum ML-DSA using 65 parameters (optional).
	 */
	public static final JWSAlgorithm ML_DSA_65 = new JWSAlgorithm("ML-DSA-65", Requirement.OPTIONAL);

	/**
	 * Post-Quantum ML-DSA using 87 parameters (optional).
	 */
	public static final JWSAlgorithm ML_DSA_87 = new JWSAlgorithm("ML-DSA-87", Requirement.OPTIONAL);


	/**
	 * Post-Quantum ML-DSA using 44 parameters (optional).
	 */
	public static final JWSAlgorithm Dilithium2 = new JWSAlgorithm("Dilithium2", Requirement.OPTIONAL);

	/**
	 * Post-Quantum ML-DSA using 65 parameters (optional).
	 */
	public static final JWSAlgorithm Dilithium3 = new JWSAlgorithm("Dilithium3", Requirement.OPTIONAL);

	/**
	 * Post-Quantum ML-DSA using 87 parameters (optional).
	 */
	public static final JWSAlgorithm Dilithium5 = new JWSAlgorithm("Dilithium5", Requirement.OPTIONAL);
	...
	public static final class Family extends AlgorithmFamily<JWSAlgorithm> {
		 ...
		 */
		public static final Family ML_DSA = new Family(ML_DSA_44, ML_DSA_65, ML_DSA_87, Dilithium2, Dilithium3, Dilithium5);
		...
		public static final Family SIGNATURE = new Family(ArrayUtils
			.concat(
				...
				ED.toArray(new JWSAlgorithm[]{}),
					ML_DSA.toArray(new JWSAlgorithm[]{})
			)
		);
	...
	public static JWSAlgorithm parse(final String s) {
		...
		if (s.equals(HS256.getName())) {
			...
			return ML_DSA_87;
		} else if (s.equals(Dilithium2.getName())) {
			return Dilithium2;
		} else if (s.equals(Dilithium3.getName())) {
			return Dilithium3;
		} else if (s.equals(Dilithium5.getName())) {
			return Dilithium5;
		} else {
