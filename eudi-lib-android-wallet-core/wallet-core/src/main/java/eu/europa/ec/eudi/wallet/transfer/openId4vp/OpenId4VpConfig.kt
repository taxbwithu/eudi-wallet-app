...
sealed interface Format {
    ...
    data class PqcJwtVc(
        val sdJwtAlgorithms: List<PqcAlgorithm>,
        val kbJwtAlgorithms: List<PqcAlgorithm>,
    ) : Format {
        companion object {
...
enum class PqcAlgorithm(
    ...
    ML_DSA_44(
        coseAlgorithmIdentifier = -98, joseAlgorithmIdentifier = "ML-DSA-44", fullySpecified = true,
