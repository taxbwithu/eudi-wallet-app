...
val NAMESPACE: String = "eu.europa.ec.eudi.wallet"
val GROUP: String = "eu.europa.ec.eudi"
val POM_SCM_URL: String = "https://github.com/eu-digital-identity-wallet/eudi-lib-android-wallet-core"
val POM_DESCRIPTION: String = "EUDI Wallet Core library for Android"
...
//    add("api", "eu.europa.ec.eudi.wallet:document-manager")
...
//    implementation(libs.nimbus.oauth2.oidc.sdk)
    ...
    implementation(libs.nstant.cbor)
